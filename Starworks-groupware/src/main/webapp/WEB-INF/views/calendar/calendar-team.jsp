...
/* 프로젝트와 주요업무는 동적 색상 사용 */
.event-type-project, .event-type-main_task {
	/* 색상은 JavaScript에서 인라인으로 적용됨 */
...
.filter-item .filter-label[for="filter-businesstrip"] {
	background-color: #e74c3c;
}

/* 프로젝트 필터는 인라인 스타일로 배경색 지정됨 */
.filter-item.project-filter-item .filter-label {
	font-size: 0.85rem; /* 프로젝트명이 길 수 있으므로 약간 작게 */
}
...
<body>
							...
							<div class="card filter-card">
								<div class="card-body filter-card-body">
									...
									<div id="filter-container">
										...
										<div class="filter-item">
											<input type="checkbox" id="filter-businesstrip"
												value="businesstrip" checked> <label
												class="filter-label" for="filter-businesstrip"> <span
												class="filter-label-text">출장</span>
											</label>
										</div>
										...
										<!-- 프로젝트 섹션 타이틀 -->
										<div class="filter-section-title">프로젝트</div>

										<!-- 프로젝트 필터 컨테이너 추가 -->
										<div id="project-filter-container"></div>
									</div>
					...
					<form id="eventForm">
						...
						<div class="mb-3">
							<label for="eventType" class="form-label">일정 구분</label> <select
								class="form-select" id="eventType" disabled>
	...
	<script src="/js/calendar/calendar-team.js"></script>
	<script>
